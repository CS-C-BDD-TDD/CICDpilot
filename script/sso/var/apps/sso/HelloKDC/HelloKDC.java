...
public final class HelloKDC {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final String username = properties.getProperty("config.preauthUsername","");
        
        // Password for the pre-auth acct.
        final String password = properties.getProperty("config.preauthPassword","");
        
        // Name of our krb5 config file
        final String krbfile = properties.getProperty("config.krb5Conf","");
        
        // Name of our login config file
        final String loginfile = properties.getProperty("config.loginConf","");
        
        // Name of our login module
        final String module = properties.getProperty("config.loginModule","");
