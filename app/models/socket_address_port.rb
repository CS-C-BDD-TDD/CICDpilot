class SocketAddressPort < ActiveRecord::Base

  self.table_name = 'socket_address_ports'
  belongs_to :port, primary_key: :cybox_object_id, foreign_key: :port_id, touch: true
  ...
  def self.ingest(uploader, obj, parent = nil)
    x = SocketAddressPort.new
    x.port_id = obj.cybox_object_id
