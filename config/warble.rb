...
Warbler::Config.new do |config|
  ...
  # config.includes = FileList["auth"]

  # Additional files/directories to exclude
  # config.excludes = FileList["lib/tasks/*"]
  
  # Database.yml is excluded s.t. we can have a remote ref to it
  config.excludes = FileList["config/database.yml","script/valves/indicators.cyber/*"] 
  ...
  config.webxml.rails.config.database.yml = ENV['DATABASE_YML'] || '/etc/cyber-indicators'
  config.webxml.rails.config.secret.key = ENV['RAILS_SECRET_KEY']
