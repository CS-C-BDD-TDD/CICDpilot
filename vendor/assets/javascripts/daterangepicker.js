...
(function(root, factory) {
  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
        keep_options[element.attr("id")] = options;
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '<button class="clearBtn"></button></div>' +
                  '</div>' +
                '</div>' +
              '</div>';
    ...
    DateRangePicker.prototype = {
        ...
        getStartDate: function() {
            if (this.startDate=='') {
                ...
                if (!this.timePicker) {
                    ...
                    // Pull off the time zone adjustment
                    return this.startDate.toString().slice(0,28);
                }
            }
        },
        ...
        getEndDate: function() {
            if (this.endDate=='') {
                ...
                if (!this.timePicker) {
                    ...
                    // Pull off the time zone adjustment
                    return this.endDate.toString().slice(0,28);
                }
            }
        },
        ...
        clickClear: function (e) {
            ...
            this.hide();
            this.element.trigger('apply.daterangepicker',this);
            this.setOptions(keep_options[this.element.attr("id")]);
            this.element.scope().date_picker_object = {
                                             startDate: null,
                                             endDate: null,
