class FixOldMifrTags < ActiveRecord::Migration
  ...
  def up
    migrate_data("MIFR-%", :is_mifr, true, 1)
  end

  def down
    migrate_data("MIFR-%", :is_mifr, false, 1)
  end

  def migrate_data(match_term, column, migration_direction, delay)
    ::Sunspot.session = ::Sunspot::Rails::StubSessionProxy.new(::Sunspot.session)
    ActiveRecord::Base.record_timestamps = false

    stix_objects = ["FixOldMifrTags::MIndicator", "FixOldMifrTags::MExploitTarget", "FixOldMifrTags::MTtp", "FixOldMifrTags::MCourseOfAction"]

    cybox_objects = ["FixOldMifrTags::MAddress", "FixOldMifrTags::MDnsQuery", "FixOldMifrTags::MDnsRecord", "FixOldMifrTags::MDomain", "FixOldMifrTags::MEmailMessage", "FixOldMifrTags::MFile", "FixOldMifrTags::MHostname", "FixOldMifrTags::MHttpSession", "FixOldMifrTags::MLink", "FixOldMifrTags::MMutex", "FixOldMifrTags::MNetworkConnection", "FixOldMifrTags::MPort", "FixOldMifrTags::MRegistry", "FixOldMifrTags::MSocketAddress", "FixOldMifrTags::MUri"]

    cybox_objects_sas = ["FixOldMifrTags::MAddress", "FixOldMifrTags::MPort", "FixOldMifrTags::MHostname"]

    cybox_object_dns_r = ["FixOldMifrTags::MAddress", "FixOldMifrTags::MDomain"]

    cybox_object_dns_q = ["FixOldMifrTags::MQuestion", "FixOldMifrTags::MResourceRecord"]
    ...
    begin
      total_groups = MPackage.where("stix_packages.title LIKE ?", match_term).where(column => !migration_direction).count / 1000
      MPackage.where("stix_packages.title LIKE ?", match_term).where(column => !migration_direction).find_in_batches.with_index do |group, batch|
